...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{url('assets/fontawesome-free-5.5.0-web/css/all.css')}}">
  ...
  <!--     Fonts and icons     -->
  <link rel="stylesheet" type="text/css" href="{{url('assets/css/fafa.css')}}" />
  <!-- <link rel="stylesheet" href="{{url('assets/css/fafa.min.css')}}"> -->
  <!-- CSS Files -->
...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
            <form class="navbar-form" method="post" action="{{url('/game')}}">
              @csrf
              <div class="input-group no-border">
                <input type="text" value="" id="search" name="search" class="form-control" placeholder="Search...">
      ...
      <div class="game_menu">
        <div class="game_grid">
          ...
          <!-- <div class="game" id="g1">
            ...
            <a href="{{url('assets/game/g1.html')}}" target="_blank"></a>
          </div>
          ...
          <div class="game" id="g2">
            ...
            <a href="{{url('assets/game/g2.html')}}" target="_blank"></a>
          </div>

          <div class="game" id="g3">
            <div class="back"></div>
            <div class="desc">
              <h3>Dolphin Olympics 2</h3>
            </div>
            <a href="{{url('assets/game/g3.html')}}" target="_blank"></a>
          </div>
          ...
          <div class="game" id="g4">
            ...
            <a href="{{url('assets/game/g4.html')}}" target="_blank"></a>
          </div>

          <div class="game" id="g5">
            <div class="back"></div>
            <div class="desc">
              <h3>Earn To Die Super Wheel</h3>
            </div>
            <a href="{{url('assets/game/g5.html')}}" target="_blank"></a>
          </div>

          <div class="game" id="g6">
            <div class="back"></div>
            <div class="desc">
              <h3>2048</h3>
            </div>
            <a href="{{url('assets/game/g6.html')}}" target="_blank"></a>
          </div>

          <div class="game" id="g7">
            <div class="back"></div>
            <div class="desc">
              <h3>Penalty Shootout</h3>
            </div>
            <a href="{{url('assets/game/g7.html')}}" target="_blank"></a>
          </div>

          <div class="game" id="g8">
            <div class="back"></div>
            <div class="desc">
              <h3>IQ Test Game</h3>
            </div>
            <a href="{{url('assets/game/g8.html')}}" target="_blank"></a>
          </div>

          <div class="game" id="g9">
            <div class="back"></div>
            <div class="desc">
              <h3>Jedi Trainer</h3>
            </div>
            <a href="{{url('assets/game/g9.html')}}" target="_blank"></a>
          </div> -->
          @foreach($game as $row)
          
          <div class="game">
            <div class="back" style="background-image: url(../public/temp/{{$row->gambar}});"></div>
            <div class="desc">
              <h3>{{$row->nama}}</h3>
            </div>
            <a href="{{url('/gameplay')}}?gameplay={{$row->game}}" target="_blank"></a>
          </div>
          @endforeach
        </div>
      </div>
  ...
  <script src="{{url('assets/js/ajaxcore.js')}}"></script>
