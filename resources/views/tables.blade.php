...
<head>
  ...
  <!-- <link rel="stylesheet" href="{{url('assets/css/fafa2.css')}}"> -->
  <!-- CSS Files -->
...
<!--           <div class="navbar-wrapper">
 ...
 -->          <button class="navbar-toggler" type="button" data-toggle="collapse" aria-controls="navigation-index" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <div class="collapse navbar-collapse justify-content-end">
           <!--  <form class="navbar-form" action="{{url('/posting/search')}}" method="get">
              @csrf
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header card-header-primary active">
                  <h4 class="card-title ">POSTING <a href="#" style="padding-left: 870px" data-toggle="modal" data-target="#modalpost"><i class="fa fa-plus"></i></a> </h4> 
                  
                </div>
                <div class="card-body">
                  <p class="card-category"> What Do You Think ? </p>
                </div>
              </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-category ouritem" data-toggle="modal" data-target="#modaledit" data-id_post="{{$row->id}}" data-post="{{$row->post}}" style="cursor: pointer;">{{$row->post}}  </p>
                ...
                <div class="modal-dialog" role="document" >
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="judul">New POST</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div class="modal-body">
                      <form action="{{url('posting/add')}}" method="post">
                        @csrf
                      <p><input type="text" name="post" placeholder="Write here" id="addItem" class="form-control"></p>
              ...
              <div class="modal" tabindex="-1" role="dialog" id="modaledit">
                <div class="modal-dialog" role="document" >
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="judul">Edit POST</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div class="modal-body">
                      <form action="{{url('/posting/update')}}" method="post">
                      @csrf
                      @method('PATCH')
                      <p>
                        <input type="text" name="post" placeholder="Write here" id="post" class="form-control">
                      </p>
                    ...
                    <div class="modal-footer">
                     <button type="submit" name="submit" class="btn btn-primary">Update</button>
                      ...
                      <form action="{{url('/posting/delete')}}" method="post">
                        @method('DELETE')
                        @csrf
  ...
  <script>
    ...
    $('#modaledit').on('show.bs.modal',function(event) {
      ...
      var id_post = a.data('id_post')
      var modal = $(this)
      console.log(modal);

      modal.find('#del').val(id_post)
